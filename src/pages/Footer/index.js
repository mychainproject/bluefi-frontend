...
function Routes() {
  return (
    <footer className="footer bleuGradient">
      <div className="container">
        <div className="row">
          <div className="col-12 col-md-4 ">
            <p className="footer__tagline text-center text-md-left">
              BleuFi Marketplace is a next generation marketplace where
            ...
            <div className="footer__content">
              <div className="footer__social">
                <div class="d-flex footerLink">
                  ...
                  <a
                    href="https://twitter.com/Bleufiofficial"
                    target="_blank"
                    rel="noreferrer"
                  >
              ...
              <small className="footer__copyright   text-center text-md-left">
                © 2021 BleuFi All Rights Reserved.{" "}
              </small>
            </div>
          </div>
        </div>
